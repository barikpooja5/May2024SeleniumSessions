...
//		
//		//it will not reach till this step if element is incorrect or not present in the page rather will throw exception
...
//		}
//		
//		System.out.println(driver.findElement(By.id("input-email")).isDisplayed());
